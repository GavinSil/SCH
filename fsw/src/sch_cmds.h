...
**
*************************************************************************/
int32 SCH_AppPipe(const CFE_SB_Buffer_t *MessagePtr);
...
**
*************************************************************************/
int32 SCH_HousekeepingCmd(const CFE_SB_Buffer_t *MessagePtr);
...
**
*************************************************************************/
void SCH_NoopCmd(const CFE_SB_Buffer_t *MessagePtr);
...
**
*************************************************************************/
void SCH_ResetCmd(const CFE_SB_Buffer_t *MessagePtr);
...
**
*************************************************************************/
void SCH_EnableCmd(const CFE_SB_Buffer_t *MessagePtr);
...
**
*************************************************************************/
void SCH_DisableCmd(const CFE_SB_Buffer_t *MessagePtr);
...
**
*************************************************************************/
void SCH_EnableGroupCmd(const CFE_SB_Buffer_t *MessagePtr);
...
**
*************************************************************************/
void SCH_DisableGroupCmd(const CFE_SB_Buffer_t *MessagePtr);
...
**
*************************************************************************/
void SCH_EnableSyncCmd(const CFE_SB_Buffer_t *MessagePtr);
...
**
*************************************************************************/
void SCH_SendDiagTlmCmd(const CFE_SB_Buffer_t *MessagePtr);
...
**
*************************************************************************/
int32 SCH_VerifyCmdLength (const CFE_SB_Buffer_t *MessagePtr, uint32 ExpectedLength);
